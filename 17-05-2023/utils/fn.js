...
export const filterChange = ()=>{
  ...
  const filterTextEl=cE("div");
  const filterTitleEl=cE("h1")
  const filterButtonEl = cE("button");
  const filterButton2El = cE("button");
  const filterButton3El = cE("button");

  filterTitleEl.textContent=("Applica uno dei filtri");
  filterButtonEl.textContent="Smarphones";
  filterButton2El.textContent="Laptops";
  filterButton3El.textContent="Fragrances";

  filterTextEl.append(filterTitleEl , filterButtonEl ,filterButton2El ,filterButton3El);
  filterEl.append(filterTextEl);
  return filterChange;
...
export const createProduct = (data) => {
  ...
  textWrapperEl.append(titleEl, descriptionEl, ratingEl ,productCategory, priceEl, buttonEl);
