const todos = [
  ...
  todoButton2EL.textContent = "Remove todo";
  ...
  document.body.append(todoInputEL, todoButtonEL, todoButton2EL, listEl);
  ...
  //E' solo una funzione che permette di pulire tutta la lista, ma è da completare 
  todoButton2EL.addEventListener("click", () => {
    todos.splice({
