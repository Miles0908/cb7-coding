...
export const tweetGen = (tweetData) => {
  ...
  texteContentEl.textContent = tweetData.body;
  reactionsEl.texteContent = tweetData.reactions;

  contentEl.append(nameEl, userNameEl, texteContentEl, reactionsEl);
